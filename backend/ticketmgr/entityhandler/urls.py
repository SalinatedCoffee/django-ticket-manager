...
urlpatterns = [
    ...
    path('event/<int:event_id>/user', views.event_users, name='event_users'),
    path('event/<int:event_id>/agent', views.event_agents, name='event_agents'),
    path('event/<int:event_id>/admin', views.event_admins, name='event_admins')
]